...
- Generated file marker: `<!-- Generated by Apple Agent Builder Kit -->` MUST be placed on the first line AFTER the frontmatter closing `---`, never before the opening `---` (placing it before frontmatter breaks YAML parsing)
